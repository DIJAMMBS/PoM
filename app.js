...
function initDynamicContent() {
  ...
  cvButtons.forEach(btn => {
    const cvUrl = data.personalInfo.cvDownloadUrl;
    ...
    btn.addEventListener('click', async (e) => {
      ...
      try {
        ...
        downloadLink.download = 'CV-Miguel-Chavez-Santoyo.pdf';
        ...
        // Si la descarga falla, abre el CV normalmente
  ...
  if (skillsContainer) {
    const categoryTitles = {
      ...
      basesDeDatos: { label: "Bases De Datos", icon: `<svg class="skills-category-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="5" rx="8" ry="3"></ellipse><path stroke-linecap="round" stroke-linejoin="round" d="M4 5v7c0 1.657 3.582 3 8 3s8-1.343 8-3V5"></path><path stroke-linecap="round" stroke-linejoin="round" d="M4 12v7c0 1.657 3.582 3 8 3s8-1.343 8-3v-7"></path></svg>` },
